    ...
    <div className="space-y-3">
      ...
      {isLoading ? (
        ...
        <div
          ...
          // Capped only where the column sits beside the runs; stacked below
          // xl, a nested scroller inside the page scroll is worse than none.
          className="space-y-4 xl:list-scroll xl:pr-1"
        >
