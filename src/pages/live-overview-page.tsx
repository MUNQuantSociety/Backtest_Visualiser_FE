        ...
        <>
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <StatTile
                    ...
                    value={
                        totals
                            ? formatSigned(totals.totalPnl, (n) => formatCurrency(n))
                            : placeholder
                    }
                    tone={totals ? toneFromValue(totals.totalPnl) : 'neutral'}
                    hint={
                        totals
                            ? formatSigned(totals.totalReturn, (n) => formatPercent(n))
                            : undefined
                    }
                    isLoading={isPending}
                />
                <StatTile
                    label="Today"
                    value={
                        totals ? formatSigned(totals.dayPnl, (n) => formatCurrency(n)) : placeholder
                    }
